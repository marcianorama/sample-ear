!function($, wysi) {
    ...
    var tpl = {
        ...
        "image": function(locale, options) {
            ...
            return "<li>" +
              "<div class='bootstrap-wysihtml5-insert-image-modal modal hide fade'>" +
                ...
                "<div class='modal-header'>" +
                  "<a class='close' data-dismiss='modal'>&times;</a>" +
                  "<h4 id='myModalLabel' class='left-tm default-titlemodule'>" + locale.image.insert + "</h4>" +
                "</div>" +
                "<div class='modal-body clear'>" +
                  "<input value='http://' class='bootstrap-wysihtml5-insert-image-url input-xlarge'>" +
                "</div>" +
                "<div class='modal-footer'>" +
                  "<a href='#' class='btn-default second-btn' data-dismiss='modal'>" + locale.image.cancel + "</a>" +
                  "<a href='#' class='btn-default' data-dismiss='modal'>" + locale.image.insert + "</a>" +
                "</div>" +
                "</div>"+
              "</div>" +
        ...
        "html": function(locale, options) {
            ...
            return "<li>" +
              "<div class='btn-group'>" +
                "<a class='btn" + size + "' data-wysihtml5-action='change_view' title='" + locale.html.edit + "' tabindex='-1'><i class='iconwysiwyg-pencil'></i></a>" +
              "</div>" +
            "</li>";
        },
