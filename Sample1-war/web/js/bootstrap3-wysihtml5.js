!function($, wysi) {
    ...
    var tpl = {
        ...
        "lists": function(locale, options) {
            ...
            return "<li>" +
                "<div class='btn-group'>" +
                "<a class='btn btn-" + size + " btn-default' data-wysihtml5-command='insertUnorderedList' title='" + locale.lists.unordered + "' tabindex='-1'><i class='fa fa-list'></i></a>" +
        ...
        "link": function(locale, options) {
            ...
            return "<li>" +
                ...
                "<h4 class='left-tm default-titlemodule'>" + locale.link.insert + "</h4>" +
		"<div class='clear'>" + "</div>" +
                "</div>" +
                ...
                "<button class='btn-default second-btn' data-dismiss='modal'>" + locale.link.cancel + "</button>" +
                "<button href='#' class='btn btn-primary btn-default' data-dismiss='modal'>" + locale.link.insert + "</button>" +
                "</div>" +
                "</div>" +
                "</div>" +
                "</div>" +
        ...
        "image": function(locale, options) {
            ...
            return "<li>" +
                ...
                "<div class='modal-header'>" +
                "<a class='close' data-dismiss='modal'>&times;</a>" +
                "<h4 class='left-tm default-titlemodule'>" + locale.image.insert + "</h4>" +
		"<div class='clear'>" + "</div>" +
                "</div>" +
                "<div class='modal-body'>" +
                ...
                "</div>" +
                "<div class='modal-footer'>" +
                "<button class='btn-default second-btn' data-dismiss='modal'>" + locale.image.cancel + "</button>" +
                "<button class='btn btn-primary btn-default' data-dismiss='modal'>" + locale.image.insert + "</button>" +
                "</div>" +
                "</div>" +
                "</div>" +
                "</div>" +
